...
class Input(ActionMap):
    ...
    jump: tuple = (
        ...
        pyxel.GAMEPAD3_BUTTON_A,
        pyxel.GAMEPAD4_BUTTON_A,
    )
    left: tuple = (
        pyxel.btn,
        pyxel.KEY_LEFT,
        ...
        pyxel.GAMEPAD3_BUTTON_DPAD_LEFT,
        pyxel.GAMEPAD4_BUTTON_DPAD_LEFT,
    )
    right: tuple = (
        pyxel.btn,
        pyxel.KEY_RIGHT,
        ...
        pyxel.GAMEPAD3_BUTTON_DPAD_RIGHT,
        pyxel.GAMEPAD4_BUTTON_DPAD_RIGHT,
    )
    ...
    crouch: tuple = (
        ...
        pyxel.GAMEPAD3_BUTTON_DPAD_DOWN,
        pyxel.GAMEPAD4_BUTTON_DPAD_DOWN,
    )
    exit: tuple = (
        pyxel.btnp,
        pyxel.KEY_ESCAPE,
        pyxel.GAMEPAD1_BUTTON_BACK,
        pyxel.GAMEPAD2_BUTTON_BACK,
        pyxel.GAMEPAD3_BUTTON_BACK,
        pyxel.GAMEPAD4_BUTTON_BACK,
    )
    restart: tuple = (
        pyxel.btnp,
        pyxel.KEY_RETURN,
        ...
        pyxel.GAMEPAD3_BUTTON_B,
        pyxel.GAMEPAD4_BUTTON_B,
    )
